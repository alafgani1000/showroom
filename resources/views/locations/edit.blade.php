...
<form role="form" method="POST" action="{{ route('loc.update') }}" enctype="multipart/form-data" id="loc-update">
    {{ csrf_field() }}
    <div class="box box-primary">
       
        <!-- /.box-header -->
        <!-- form start -->      
        <input type="hidden" name="location_id" id="loc_id" value="{{ $loc->id }}">         
        <div class="box-body">
            <div class="form-group">
                <label for="text">Name</label>
                <input name="text" type="text" class="form-control" id="edit-textid" placeholder="Text" value="{{ $loc->text }}">              

...
<!-- Content Header (Page header) -->
  ...
  <section class="content">
    <div class="row">
      ...
      <form role="form" method="POST" action="{{ route('tr.update') }}" enctype="multipart/form-data">
        {{ csrf_field() }}
        ...
        <div class="box-body">
          <div class="form-group">
            ...
            <input name="noid" type="text" class="form-control" id="Nomor Identitas" placeholder="Nomor Identitas" value="{{ $product->supplier->noid }}">              
              <span class="invalid-feedback" role="alert">
              </span>
          </div>
          <div class="form-group">
            <label for="nama">Nama</label>
            <input name="nama" type="text" class="form-control" id="Nama" placeholder="Nama" value="{{ $product->supplier->nama }}">              
            <span class="invalid-feedback" role="alert">
            </span>
        </div>
        <div class="form-group">
          <label>Alamat</label>
          <textarea name="alamat" class="form-control" rows="4" placeholder="Alamat">{{ $product->supplier->alamat }}</textarea>
          <span class="invalid-feedback" role="alert">
              <strong></strong>
          </span>
        </div>
          ...
          <!-- form start -->
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input name="nokend" type="text" class="form-control" id="nokend" placeholder="Nomor Kendaraan" value="{{ $product->nomor_kendaraan }}">              
                    <span class="invalid-feedback" role="alert">
                    </span>
                </div>
                <div class="form-group">
                  <label for="nama_product">Merk</label>
                  <input name="nama_product" type="text" class="form-control" id="nama_product" placeholder="Merk" value="{{ $product->nama_product }}">              
                    <span class="invalid-feedback" role="alert">
                    </span>
                </div>
                <div class="form-group">
                  <label for="warna">Warna</label>
                  <input name="warna" type="text" class="form-control" id="warna" placeholder="Warna" value="{{ $product->warna }}">              
                    <span class="invalid-feedback" role="alert">
                    </span>
                </div>
              <div>
                <label for="norangka">Nomor Kerangka</label>
                <input name="norangka" type="text" class="form-control" id="norangka" placeholder="Nomor Kerangka" value="{{ $product->norangka }}">              
                  <span class="invalid-feedback" role="alert">
                  </span>
              </div>
              <div>
                <label for="nomesin">Nomor Mesin</label>
                <input name="nomesin" type="text" class="form-control" id="nomesin" placeholder="Nomor Mesin" value="{{ $product->nomesin }}">              
                  <span class="invalid-feedback" role="alert">
                  </span>
              </div>
                <div class="form-group">
                  <label for="stnk">Stnk</label>
                  <input name="stnk" type="file" >
                  <p class="help-block">Example block-level help text here.</p>
                </div>
                <div class="form-group">
                  <label for="bpkb">Bpkb</label>
                  <input name="bpkb" type="file" >
                  <p class="help-block">Example block-level help text here.</p>
                </div>
                <!-- /.box-body -->  
            </div>
          ...
          <div class="box-body">
            ...
            <div class="form-group" id="formDetail">
              ...
              <div class="form-group row detail">
                  <div class="col-md-4">
                      <input type="text"  class="form-control" placeholder="text" name="detail[nomor][0]">
                  </div>
                  <div class="col-md-4">
                      <input type="text"  class="form-control" placeholder="text" name="detail[nama][0]">
                  </div>
                  <div class="col-md-4">
        ...
        <div class="box box-primary">
          ...
          <div class="box-body">
            <div class="form-group">
              ...
              <input name="cost" type="text" class="form-control" id="cost" placeholder="Harga pembelian" value="{{ $product->purchase->cost }}">              
                <span class="invalid-feedback" role="alert">
                </span>
            </div>
          <div class="form-group">
            <label for="stnk">Tanggal Beli</label>
            <input name="purchase_date" type="text" class="form-control pull-right datepicker"  value="{{ $product->purchase->purchase_date }}">
            <p class="help-block">Example block-level help text here.</p>
          </div>
          <!-- /.box-body -->
          <div class="form-group">
